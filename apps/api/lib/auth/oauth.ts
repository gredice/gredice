...
export function generateAuthUrl(provider: keyof typeof oauthConfigs, state: string) {
...
export async function fetchUserInfo(provider: keyof typeof oauthConfigs, accessToken: string) {
    const config = oauthConfigs[provider]
