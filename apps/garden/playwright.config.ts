...
const webglTestPattern =
    /(actor-speech-bubble|cursor-anchored-zoom|detailed-inspection-farmer|garden-preview-capture|hover-outline|instanced-mesh-material-swap)\.spec\.tsx|outlet-garden-route\.spec\.ts/;
