...
const webglComponentTestPattern =
    /(actor-speech-bubble|cursor-anchored-zoom|detailed-inspection-farmer|garden-building-avatar-interiors|garden-building-vertical-slice|garden-preview-capture|garden-structure-kit-renderer|hover-outline|instanced-mesh-material-swap|precipitation-camera-follow|public-garden-switch|raised-bed-notification-bubble|solar-eclipse)\.spec\.tsx/;
