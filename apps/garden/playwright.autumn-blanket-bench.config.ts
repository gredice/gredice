...
export default defineConfig({
    ...config,
    testMatch: 'tests/autumn-blanket-bench.capture.tsx',
    timeout: 120_000,
        ...
        ...(config.projects
            ...
            .map((project) => ({
                ...
                snapshotPathTemplate: fileURLToPath(
                    new URL(
                        '../../docs/autumn-blanket-bench-2026/{arg}{ext}',
                        import.meta.url,
                    ),
                ),
                use: {
        ...
        ...(config.projects
            ...
            .map((project) => ({
                ...
                testMatch: [
                    ...
                    'tests/autumn-blanket-bench-rotation.spec.tsx',
                ],
                grep: /blanket bench|autumn-blanket-bench|Drvena klupa/,
            })) ?? []),
    ],
    webServer: undefined,
});
