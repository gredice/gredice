...
export default defineConfig({
    ...config,
    testMatch: 'tests/chestnut-cart.capture.tsx',
    timeout: 120_000,
        ...
        ...(config.projects
            ...
            .map((project) => ({
                ...
                snapshotPathTemplate: fileURLToPath(
                    new URL(
                        '../../docs/chestnut-cart-2026/{arg}{ext}',
                        import.meta.url,
                    ),
                ),
                use: {
        ...
        ...(config.projects
            ...
            .map((project) => ({
                ...
                testMatch: [
                    ...
                    'tests/chestnut-cart-rotation.spec.tsx',
                ],
                grep: /chestnut cart|chestnut-cart|Kolica s pečenim kestenima/,
            })) ?? []),
    ],
    webServer: undefined,
});
