import { SocialCard } from '@apps/www/components/social/SocialCard';
...
const meta = {
    ...
    args: {
        ...
        bgIconColor: 'bg-gradient-to-br from-purple-500 to-pink-500',
        navigateIconColor: 'text-pink-500',
    },
    render: (args) => (
        <div className="w-80">
            <SocialCard {...args} />
...
export const Facebook: Story = {
    args: {
        href: 'https://www.facebook.com/gredice',
