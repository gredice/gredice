        ...
        <Link href="https://gredice.link/ig">
            <Card className={cx(
                ...
                <CardHeader className={cx("flex flex-row gap-4 items-center")}>
                    <div className={cx("size-16 shrink-0 rounded-full flex items-center justify-center shadow-lg", "bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045]")}>
                ...
                <CardContent className="pt-2">
                    <Navigate className={cx("size-8 shrink-0", "text-[#fcb045]")} />
                </CardContent>
            </Card>
        </Link>
    );
