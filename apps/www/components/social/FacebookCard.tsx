        ...
        <Link href="https://gredice.link/fb">
            <Card className={cx(
                ...
                <CardHeader className={cx("flex flex-row gap-4 items-center")}>
                    <div className={cx("size-16 shrink-0 rounded-full flex items-center justify-center shadow-lg", "bg-[#1877F2]")}>
                ...
                <CardContent className="pt-2">
                    <Navigate className={cx("size-8 shrink-0", "text-blue-600")} />
                </CardContent>
            </Card>
        </Link>
    );
