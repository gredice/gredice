                ...
                <Stack>
                    ...
                    <StyledHtml>
                        <p>
                            ...
                            adresu - ili te čekamo da ga preuzmeš osobno. U
                            nastavku možeš saznati kako funkcionira dostava,
                            koje su opcije dostupne i koji su uvjeti.
                        </p>
                        <Typography
                            level="body2"
                            className="text-muted-foreground italic"
                        >
                            Napomena: planiraj dostavu barem 48 sati unaprijed
                            kako bismo stigli pripremiti tvoje povrće i
                            organizirati dostavu na vrijeme. Termini unutar dva
                            dana često više nisu dostupni.
                        </Typography>
                        <h2 id="besplatna-dostava">🆓 Besplatna dostava</h2>
                        <p>
                            Ukoliko tvoja dostava sadrži povrće od biljke za
                            koju se radi prva dostava, ostvaruješ pravo na{' '}
                            <strong>besplatnu dostavu</strong> za područje
                            Zagreba, bez obzira na količinu povrća koju želiš
                            primiti u toj dostavi.
                        </p>
                        <Alert startDecorator={'ℹ️'} color="info">
                            Za više besplatnih dostava, u berbu uključi barem
                            jednu biljku koja se prvi put dostavlja.
                            <br />
                            Na taj način možeš ostvariti pravo na{' '}
                            <strong>18 besplatnih</strong> dostava za gredicu sa
                            18 posađenih biljaka.
                        </Alert>
                        <p>
                            <small>
                                <em>
                                    Pravo na besplatnu dostavu možeš iskoristiti
                                    najviše jednom tjedno. Ako želiš dodatne
                                    dostave u istom tjednu možeš ih naručiti po
                                    standardnoj cijeni.
                                </em>
                            </small>
                        </p>
                        ...
                        <p>
                            ...
                            <strong>
                                {formatPrice(distanceSurchargePerKm)} po
                                kilometru
                            </strong>{' '}
                            od naše najbliže{' '}
                        ...
                        <p>
                            Vidi mapu zona dostave i tablicu s cijenama ispod:
                        </p>
                        <div>
                            <figure className="w-full aspect-[4/3] mb-4 text-center">
                                ...
                                <figcaption>
                                    ...
                                    <em>
                                        zone su okvirne, a stvarne zone dostave
                                        mogu se razlikovati.
                                    </em>
                                </figcaption>
                            </figure>
                        ...
                        <p>
                            ...
                            preuzimanje&quot; i odaberi lokaciju i termin koji
                            ti najviše odgovara.
                        </p>
                        ...
                        <p>
                            ...
                            <strong>48 sati</strong> prije željenog termina.
                            Nakon što zatražiš dostavu, obavijestit ćemo te ako
                            je ona potvrđena ili eventualno odbijena, ovisno o
                            trenutačnoj popunjenosti rasporeda.
                        </p>
                        <p>
                            Dostave se odvijaju u{' '}
                            <strong>2-satnim vremenskim blokovima</strong>, a
                            sve dostupne termine možeš vidjeti u aplikaciji ili
                            na našoj stranici s terminima. Ako te ne pronađemo
                            na adresi u dogovoreno vrijeme, pokušat ćemo te
                            kontaktirati. U slučaju da dostava ipak ne uspije,
                            svoje povrće možeš naknadno osobno preuzeti na našoj
                            lokaciji u Zagrebu. Ako povrće ne preuzmeš u roku od{' '}
                            <strong>72 sata</strong>, donirat ćemo ga onima
                            kojima je najpotrebnije.
                        </p>
                        <hr />
                        <p>
                            Tvoje povrće čeka da stigne do tebe - svježe,
                            lokalno i s ljubavlju uzgojeno. 🥬📦
                        </p>
                        <hr />
                    </StyledHtml>
                </Stack>
