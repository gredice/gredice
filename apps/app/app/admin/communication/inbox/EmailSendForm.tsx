...
export function EmailSendForm({ from }: { from: string }) {
    ...
    const [state, formAction, pending] = useActionState(submitEmailForm.bind(null, attachments), null);
    ...
    const handleFileChange = (e: ChangeEvent<HTMLInputElement>) => {
        if (e.target.files) {
            ...
            if (newTotalSize <= MAX_FILE_SIZE) {
                ...
                alert("Ukupna veličina priloga prelazi maksimalnu dozvoljenu veličinu od 10MB. Molimo uklonite neke priloge ili smanjite veličinu priloga.")
