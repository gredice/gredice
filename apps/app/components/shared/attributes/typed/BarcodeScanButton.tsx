...
export function BarcodeScanButton({
    ...
    const getCameraLabel = useCallback(
        (camera: MediaDeviceInfo, index: number): string => {
            if (camera.label) {
    ...
    const loadSavedCameraIndex = useCallback((maxCameras: number): number => {
        try {
    ...
    const startCameraScanning = async () => {
        ...
        try {
            ...
            if (availableCameras.length > 0) {
                ...
                setActiveCameraLabel(
                    getCameraLabel(camera, selectedCameraIndex),
                );
            }
    ...
    const handleScanSuccess = useCallback(
        ...
        [onScan, lastScannedCode, stopCameraScanning],
    );
    ...
    return (
        <>
            ...
            >
                {children || <Tally3 className="size-4" />}
            </Button>
            ...
            >
                <Row className="flex items-center justify-between">
                    <div className="flex items-center gap-2">Scan Barcode</div>
                        ...
                        {scanState === 'idle' && (
                            <div className="absolute inset-0 flex items-center justify-center bg-gray-200">
                                <div className="text-center text-gray-500">
                                    <p>
                                        Odabrana kamera će biti prikazana ovdje
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        {scanState === 'requesting-permission' && (
                            <div className="absolute inset-0 flex items-center justify-center bg-gray-200">
                                <div className="text-center text-gray-500">
                                    ...
                                    <p>
                                        Potrebna dozvola za korištenje kamere...
                                    </p>
                                </div>
                            </div>
                        )}
