import { Head, Html, Preview, Section, Tailwind } from "@react-email/components";
        ...
        <Html>
            ...
            <Tailwind>
                <ContentCard>
                    ...
                    <Paragraph>Primili smo zahtjev za brisanje računa: <strong>{email}</strong></Paragraph>
                    <Paragraph>Ako navedeni email odgovara traženom, klikni na gumb ispod za potvrdu.</Paragraph>
                    <Section className="my-[32px] text-center">
                        <PrimaryButton href={confirmLink}>Potvrdi brisanje računa</PrimaryButton>
                    </Section>
                    <Paragraph>
