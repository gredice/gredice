...
export const aiUsageLedger = pgTable(
    'ai_usage_ledger',
    {
        ...
        reservedMicroEur: integer('reserved_micro_eur').notNull().default(0),
        inputMicroEur: integer('input_micro_eur').notNull().default(0),
        outputMicroEur: integer('output_micro_eur').notNull().default(0),
        totalMicroEur: integer('total_micro_eur').notNull().default(0),
        error: text('error'),
        createdAt: timestamp('created_at').notNull().defaultNow(),
...
export const aiAccountLimitOverrides = pgTable(
    'ai_account_limit_overrides',
    {
        accountId: text('account_id')
            .primaryKey()
            .references(() => accounts.id),
        activeDailyLimitMicroEur: integer('active_daily_limit_micro_eur'),
        activeWeeklyLimitMicroEur: integer('active_weekly_limit_micro_eur'),
        trialDailyLimitMicroEur: integer('trial_daily_limit_micro_eur'),
        trialWeeklyLimitMicroEur: integer('trial_weekly_limit_micro_eur'),
