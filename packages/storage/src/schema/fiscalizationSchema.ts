...
export const fiscalizationUserSettings = pgTable(
    'fiscalization_user_settings',
    {
        ...
        receiptNumberOnDevice: boolean('receipt_number_on_device')
            .notNull()
            .default(false), // Whether the receipt number is generated on the device
...
export const fiscalizationPosSettings = pgTable(
    'fiscalization_pos_settings',
    {
        id: serial('id').primaryKey(),
...
// Type exports
export type InsertFiscalizationUserSettings =
    typeof fiscalizationUserSettings.$inferInsert;
export type UpdateFiscalizationUserSettings = Partial<
    Omit<
        typeof fiscalizationUserSettings.$inferInsert,
        'id' | 'accountId' | 'createdAt' | 'updatedAt' | 'isDeleted'
    >
> &
    Pick<typeof fiscalizationUserSettings.$inferSelect, 'id'>;
export type SelectFiscalizationUserSettings =
    typeof fiscalizationUserSettings.$inferSelect;

export type InsertFiscalizationPosSettings =
    typeof fiscalizationPosSettings.$inferInsert;
export type UpdateFiscalizationPosSettings = Partial<
    Omit<
        typeof fiscalizationPosSettings.$inferInsert,
        'id' | 'accountId' | 'createdAt' | 'updatedAt' | 'isDeleted'
    >
...
export type SelectFiscalizationPosSettings =
    typeof fiscalizationPosSettings.$inferSelect;
