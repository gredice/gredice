...
CREATE INDEX "automation_run_steps_status_idx" ON "automation_run_steps" USING btree ("status");--> statement-breakpoint
...
CREATE INDEX "automation_runs_created_at_idx" ON "automation_runs" USING btree ("created_at");
