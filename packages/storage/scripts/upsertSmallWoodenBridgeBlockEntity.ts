...
const blockName = 'SmallWoodenBridge';
const entityTypeName = 'block';

const smallWoodenBridgeAttributes = {
    'attributes.height': '0.38',
    ...
    'information.fullDescription':
        'Mali drveni most s blago zakrivljenim gazištem i širokim daskama. Postavi ga preko jednog vodenog bloka ili ga upotrijebi kao topao ukrasni detalj na vrtnoj stazi.',
    'information.label': 'Mali drveni most',
...
async function main() {
    ...
    const missingDefinitions = Object.keys(smallWoodenBridgeAttributes).filter(
    ...
    for (const [path, value] of Object.entries(smallWoodenBridgeAttributes)) {
