...
const blockName = 'InflatablePoolSmall';
...
const inflatablePoolSmallAttributes = {
    'attributes.height': '0.35',
    'attributes.hitboxDepth': '1.2',
    'attributes.hitboxHeight': '0.35',
    'attributes.hitboxWidth': '1.2',
    ...
    'information.fullDescription':
        'Mali napuhani bazen s plitkom vodom za ljetno uređenje vrta, igre i opuštene sezonske kutke.',
    'information.label': 'Mali napuhani bazen',
    'information.name': blockName,
    'information.shortDescription':
        'Mali napuhani bazen s plitkom vodom za ljetno uređenje vrta.',
...
async function main() {
    ...
    for (const [path, value] of Object.entries(inflatablePoolSmallAttributes)) {
