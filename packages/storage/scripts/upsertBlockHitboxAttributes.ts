...
const blockHitboxes = {
    ...
    RabbitHutch: { width: 0.89, height: 0.971, depth: 1.021 },
    HorseStable: { width: 1.869, height: 1.703, depth: 1.72 },
    CowShelter: { width: 1.88, height: 1.485, depth: 1.65 },
    GoatShelter: { width: 0.98, height: 1, depth: 0.979 },
    SheepFold: { width: 1.72, height: 1.445, depth: 1.52 },
    ...
    Block_Dry_Ground: cell(0.4),
    Block_Dry_Ground_Angle: cell(0.4),
    Block_Dry_Ground_Corner: cell(0.4),
    Block_Dry_Ground_Reverse_Corner: cell(0.4),
    Block_Sand: cell(0.4),
    ...
    Fence: cell(0.58),
    PolishedStoneFence: cell(0.68),
    StoneFence: cell(0.68),
