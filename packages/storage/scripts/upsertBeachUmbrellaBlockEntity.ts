...
const beachUmbrellaAttributes = {
    'attributes.height': '1.8',
    'attributes.hitboxDepth': '1.2',
    'attributes.hitboxHeight': '1.8',
    ...
    'information.fullDescription':
        'Suncobran za ljetne kutke, plažne scene i male zone hlada u vrtu.',
    'information.label': 'Suncobran',
    'information.name': blockName,
    'information.shortDescription':
        'Suncobran za ljetne kutke, plažne scene i male zone hlada u vrtu.',
    'prices.sunflowers': '110',
...
async function main() {
    ...
    const missingDefinitions = Object.keys(beachUmbrellaAttributes).filter(
    ...
    for (const [path, value] of Object.entries(beachUmbrellaAttributes)) {
