...
const beachChairAttributes = {
    'attributes.height': '0.55',
    'attributes.hitboxDepth': '0.95',
    'attributes.hitboxHeight': '0.55',
    'attributes.hitboxWidth': '0.7',
    ...
    'information.fullDescription':
        'Ležaljka za plažu kao opušteni ljetni dekorativni blok za vrt, uz ručnike, bazen ili palme.',
    'information.label': 'Ležaljka za plažu',
    'information.name': blockName,
    'information.shortDescription':
        'Ležaljka za plažu kao opušteni ljetni dekorativni blok za vrt.',
...
async function main() {
    ...
    const missingDefinitions = Object.keys(beachChairAttributes).filter(
    ...
    for (const [path, value] of Object.entries(beachChairAttributes)) {
