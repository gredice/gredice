...
const iceCreamCartAttributes = {
    ...
    'information.fullDescription':
        'Mala kolica za sladoled za vedre ljetne i tržničke vrtne scene. Ukrašavaju sezonske kutke i stvaraju veseli prostor za druženje u vrtu.',
    'information.label': 'Kolica za sladoled',
    'information.name': blockName,
    'information.shortDescription':
        'Mala kolica za sladoled za vedre ljetne i tržničke vrtne scene.',
    'prices.sunflowers': '160',
...
async function main() {
    ...
    const missingDefinitions = Object.keys(iceCreamCartAttributes).filter(
    ...
    for (const [path, value] of Object.entries(iceCreamCartAttributes)) {
