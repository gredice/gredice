...
const beachBallAttributes = {
    'attributes.height': '0.32',
    'attributes.hitboxDepth': '0.38',
    'attributes.hitboxHeight': '0.32',
    'attributes.hitboxWidth': '0.38',
    ...
    'information.fullDescription':
        'Šarena lopta za plažu za razigrane ljetne vrtne scene i veseli detalj uz bazen, ručnik ili ležaljku.',
    'information.label': 'Lopta za plažu',
    'information.name': blockName,
    'information.shortDescription':
        'Šarena lopta za plažu za razigrane ljetne vrtne scene.',
    'prices.sunflowers': '35',
...
async function main() {
    ...
    const missingDefinitions = Object.keys(beachBallAttributes).filter(
    ...
    for (const [path, value] of Object.entries(beachBallAttributes)) {
