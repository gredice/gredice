...
const palmTreeAttributes = {
    'attributes.height': '1.5',
    'attributes.hitboxDepth': '0.85',
    'attributes.hitboxHeight': '1.5',
    'attributes.hitboxWidth': '0.85',
    ...
    'information.fullDescription':
        'Mala palma kao topli ljetni naglasak i viši dekorativni blok za tropske vrtne kutke.',
    'information.label': 'Palma',
    'information.name': blockName,
    'information.shortDescription':
        'Mala palma kao topli ljetni naglasak i viši dekorativni blok.',
...
async function main() {
    ...
    const missingDefinitions = Object.keys(palmTreeAttributes).filter(
    ...
    for (const [path, value] of Object.entries(palmTreeAttributes)) {
