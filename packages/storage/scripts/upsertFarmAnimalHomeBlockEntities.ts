...
import { persistentPetHomeBlockSpecs } from './lib/persistentPetHomeCatalog';
...
// not live. The five newer persistent pets use distinct home blocks so their
// catalogue entry, placed model, and runtime spawn anchor stay the same object.
