...
const blockName = 'OutletDisplayTable';
const entityTypeName = 'block';

const outletDisplayTableAttributes = {
    'attributes.height': '0.67',
    'attributes.hitboxDepth': '0.75',
    'attributes.hitboxHeight': '0.67',
    'attributes.hitboxWidth': '0.9',
    ...
    'information.label': 'Drveni izložbeni stol',
...
async function main() {
    ...
    const missingDefinitions = Object.keys(outletDisplayTableAttributes).filter(
    ...
    for (const [path, value] of Object.entries(outletDisplayTableAttributes)) {
