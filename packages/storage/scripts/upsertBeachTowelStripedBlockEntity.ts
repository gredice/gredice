...
const blockName = 'BeachTowelStriped';
...
const beachTowelStripedAttributes = {
    'attributes.height': '0.08',
    'attributes.hitboxDepth': '0.65',
    'attributes.hitboxHeight': '0.08',
    'attributes.hitboxWidth': '1.4',
    ...
    'information.fullDescription':
        'Prugasti ručnik za plažu za ljetne vrtne kutke, rubove vode i opuštene scene u vrtu.',
    'information.label': 'Prugasti ručnik za plažu',
    'information.name': blockName,
    'information.shortDescription':
        'Prugasti ručnik za plažu za ljetne vrtne kutke i opuštene scene.',
...
async function main() {
    ...
    const missingDefinitions = Object.keys(beachTowelStripedAttributes).filter(
    ...
    for (const [path, value] of Object.entries(beachTowelStripedAttributes)) {
