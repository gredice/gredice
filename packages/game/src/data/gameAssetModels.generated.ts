...
export const gameAssetModels = {
    ...
    LemonadeStand: { url: '/assets/models/LemonadeStand.glb' },
    IceCreamCart: { url: '/assets/models/IceCreamCart.glb' },
    ...
    BeachChair: { url: '/assets/models/BeachChair.glb' },
    WoodenBench: { url: '/assets/models/WoodenBench.glb' },
    OutletDisplayTable: {
