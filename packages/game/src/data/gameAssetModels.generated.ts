...
export const gameAssetModels = {
    ...
    Chicken: { url: '/assets/models/Chicken.glb' },
    Piglet: { url: '/assets/models/Piglet.glb' },
    ...
    ChickenCoop: { url: '/assets/models/ChickenCoop.glb' },
    PigletPen: { url: '/assets/models/PigletPen.glb' },
    SmallWoodenBridge: {
