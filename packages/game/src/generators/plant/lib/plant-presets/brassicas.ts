...
const basalBulbBase: PlantDefinition = {
    ...
    rules: {
        F: [
            { rule: 'F(1.04,1)[+(16)L(1.04)][-(16)L(1.04)]', weight: 2 },
            { rule: 'F(0.96,0.98)[^(12)L(0.96)][&(12)L(0.96)]', weight: 1 },
        ],
        L: [
            {
                rule: '[+(12)F(0.82,0.86)L(0.98)][-(12)F(0.82,0.86)L(0.98)]F(0.9,0.9)L(1.04)',
                weight: 2,
            },
            {
                rule: '[+(10)F(0.78,0.82)^(10)L(0.94)][-(10)F(0.78,0.82)&(10)L(0.94)]F(0.88,0.88)L(1)',
                weight: 1,
            },
        ],
    },
