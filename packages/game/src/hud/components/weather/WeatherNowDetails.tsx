        ...
        <Stack>
            ...
            <Row className="px-4 py-2" justifyContent="space-between">
                <Typography level="body3" className='flex gap-1'>
                    ...
                    <Link href={"https://meteo.hr/proizvodi.php?section=podaci&param=xml_korisnici"} target='_blank' className="flex gap-1 items-center">
                    ...
                    <span>•</span>
                    <Link href="https://signalco.io" target="_blank" className="flex gap-1 items-center">
                        <img
