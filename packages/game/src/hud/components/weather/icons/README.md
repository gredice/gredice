...
compatibility. `RainIcon` reuses the raindrop with its existing bottom-up probability
...
and probability fill; `weatherComposition.unit.ts` checks condition coverage,
