...
export const SunnyMediumCloudsAndThunder = createDayNightIcon(
    (props) => (
        <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <path d="M24 18C24 21.3137 21.3137 24 18 24H10C6.68629 24 4 21.3137 4 18C4 14.6863 6.68629 12 10 12H18C21.3137 12 24 14.6863 24 18Z" fill="#E6E6E6" />
            <path d="M16 20L14 24H18L16 28" stroke="#FFD700" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    ),
    (props) => (
        <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <path d="M24 18C24 21.3137 21.3137 24 18 24H10C6.68629 24 4 21.3137 4 18C4 14.6863 6.68629 12 10 12H18C21.3137 12 24 14.6863 24 18Z" fill="#A9A9A9" />
            <path d="M16 20L14 24H18L16 28" stroke="#FFD700" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
)
