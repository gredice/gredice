...
export type SegmentedProgressProps = {
    segments: { value: number, indeterminate?: boolean, highlighted?: boolean, label?: string, onClick?: () => void }[]
                    ...
                    <Fragment key={segment.label ?? index}>
                        ...
                        <CircleComponent
                            ...
                            className={cx(
                                ...
                                segment.onClick && 'cursor-pointer hover:outline outline-offset-1 outline-2',
                            )}>
                            <div className={cx(
