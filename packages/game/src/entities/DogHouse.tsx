...
import { dogHouseWoodColors } from './woodPalette';
...
const darkWallMaterial = {
    color: dogHouseWoodColors.darkWall,
    metalness: 0,
    roughness: 0.92,
    side: DoubleSide,
};
