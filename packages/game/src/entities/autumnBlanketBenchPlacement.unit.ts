...
const candidate = { name: autumnBlanketBench.name, id: 'bench', rotation: 0 };
const grass = (id: string) => ({ name: 'Block_Grass', id, rotation: 0 });

describe('AutumnBlanketBench placement', () => {
    ...
    it('fails closed for missing blanket bench metadata and preserves unrelated rotations', () => {
