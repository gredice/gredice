...
const candidate = { name: chestnutRoastingCart.name, id: 'cart', rotation: 0 };
const grass = (id: string) => ({ name: 'Block_Grass', id, rotation: 0 });

describe('ChestnutRoastingCart placement', () => {
    ...
    it('fails closed for missing chestnut cart metadata and preserves unrelated rotations', () => {
