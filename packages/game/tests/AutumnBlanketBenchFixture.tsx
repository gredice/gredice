...
import { AutumnBlanketBenchProbe } from './AutumnBlanketBenchProbe';

export function AutumnBlanketBenchFixture({
    rotation,
    light = 'day',
    small = false,
    raised = false,
        ...
        <NuqsAdapter>
            <QueryClientProvider client={client}>
                <GameStateContext.Provider value={store}>
                    <div
                        data-testid="autumn-blanket-bench"
                        data-ready={ready}
                        data-hit={hit}
