...
import { AutumnBlanketBenchRotationControls } from './AutumnBlanketBenchRotationControls';

export function AutumnBlanketBenchRotationFixture({
    obstacle,
}: {
    obstacle?: 'crate' | 'raised';
}) {
    const storageKey = `autumn-blanket-bench-rotation-${obstacle ?? 'clear'}`;
        ...
        <NuqsAdapter>
            <QueryClientProvider client={client}>
                <GameStateContext.Provider value={store}>
                    <AutumnBlanketBenchRotationControls />
