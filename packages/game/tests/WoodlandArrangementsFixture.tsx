...
import { WoodlandArrangementsProbe } from './WoodlandArrangementsProbe';

export function WoodlandArrangementsFixture({
    rotation,
    light = 'day',
    small = false,
    date = '2026-09-23',
        ...
        <NuqsAdapter>
            <QueryClientProvider client={client}>
                <GameStateContext.Provider value={store}>
                    <div
                        data-testid="woodland-arrangements"
                        data-ready={ready}
                        data-hit={hit}
