...
import { GardenBrazierProbe } from './GardenBrazierProbe';

export function GardenBrazierFixture({
    rotation,
    light = 'day',
    small = false,
    raised = false,
    ...
    const store = useMemo(() => {
        ...
        state.setState({ weatherVisualizationDisabled: weatherDisabled });
        return state;
    }, [light, weatherDisabled]);
                    ...
                    >
                        ...
                        The full close-up HUD is DOM above the scene and has separate app tests. */}
                                ...
                                <GardenBrazierProbe
                                    onReady={setReady}
                                    weather={
                                        weatherDisabled ? 'disabled' : light
                                    }
                                />
                            </Suspense>
                        </Scene>
