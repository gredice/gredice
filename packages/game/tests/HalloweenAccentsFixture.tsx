...
import { HalloweenAccentsProbe } from './HalloweenAccentsProbe';

export function HalloweenAccentsFixture({
    rotation,
    light = 'day',
    small = false,
    raised = false,
                ...
                return {
                    ...
                    blocks: [
                        ...
                        ...(x === -1 && z === (raised ? -1 : 0)
                            ...
                            : []),
                        ...(x === 1 && z === 0
                            ? [{ name: 'WhiteFence', id: 'fence', rotation: 0 }]
                            : []),
                        ...(x === 1 && z === 1
                            ? [
                                  {
                ...
                <GameStateContext.Provider value={store}>
                    ...
                    >
                        ...
                        The full close-up HUD is DOM above the scene and has separate app tests. */}
                                ...
                                <group name="review-bats">
                                    <Bats
                                        stacks={stacks}
                                        gardenId="halloween-review"
                                        weather={weather}
                                    />
                                </group>
                                <HalloweenAccentsProbe
                                    onReady={setReady}
                                    weather={light}
                                />
                            </Suspense>
