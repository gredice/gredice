...
import { FallenLogRotationControls } from './FallenLogRotationControls';

export function FallenLogRotationFixture({
    obstacle,
}: {
    obstacle?: 'crate' | 'raised';
}) {
    const storageKey = `fallen-log-rotation-${obstacle ?? 'clear'}`;
