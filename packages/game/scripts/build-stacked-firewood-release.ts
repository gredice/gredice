...
const name = stackedFirewood.name;
    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.StackedFirewood.url}`,
            triangles,
...
mkdirSync(new URL('docs/stacked-firewood-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/stacked-firewood-2026/release-manifest.json', root),
