...
const name = seedDryingRack.name;
    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.SeedDryingRack.url}`,
            triangles,
...
mkdirSync(new URL('docs/seed-drying-rack-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/seed-drying-rack-2026/release-manifest.json', root),
