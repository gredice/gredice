    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.BirdFeeder.url}`,
            triangles,
...
mkdirSync(new URL('docs/bird-feeder-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/bird-feeder-2026/release-manifest.json', root),
