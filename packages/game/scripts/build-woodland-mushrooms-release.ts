...
const name = woodlandMushrooms.name;
    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.WoodlandMushrooms.url}`,
            triangles,
...
mkdirSync(new URL('docs/woodland-mushrooms-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/woodland-mushrooms-2026/release-manifest.json', root),
