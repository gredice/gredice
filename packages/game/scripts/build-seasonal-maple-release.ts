    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.SeasonalMaple.url}`,
            triangles,
...
mkdirSync(new URL('docs/seasonal-maple-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/seasonal-maple-2026/release-manifest.json', root),
