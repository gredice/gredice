...
const name = autumnBlanketBench.name;
    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.AutumnBlanketBench.url}`,
            triangles,
...
mkdirSync(new URL('docs/autumn-blanket-bench-2026/', root), {
    recursive: true,
});
writeFileSync(
    new URL('docs/autumn-blanket-bench-2026/release-manifest.json', root),
