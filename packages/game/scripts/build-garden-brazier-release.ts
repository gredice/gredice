    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.GardenBrazier.url}`,
            triangles,
...
mkdirSync(new URL('docs/garden-brazier-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/garden-brazier-2026/release-manifest.json', root),
