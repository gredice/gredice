    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.AutumnShrub.url}`,
            triangles,
...
mkdirSync(new URL('docs/autumn-shrub-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/autumn-shrub-2026/release-manifest.json', root),
