...
const name = chestnutRoastingCart.name;
    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.ChestnutRoastingCart.url}`,
            triangles,
...
mkdirSync(new URL('docs/chestnut-cart-2026/', root), {
    recursive: true,
});
writeFileSync(
    new URL('docs/chestnut-cart-2026/release-manifest.json', root),
