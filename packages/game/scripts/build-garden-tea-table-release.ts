...
const name = gardenTeaTable.name;
    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.GardenTeaTable.url}`,
            triangles,
...
mkdirSync(new URL('docs/garden-tea-table-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/garden-tea-table-2026/release-manifest.json', root),
