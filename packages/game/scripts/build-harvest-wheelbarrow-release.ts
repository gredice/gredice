...
const name = harvestWheelbarrow.name;
    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.HarvestWheelbarrow.url}`,
            triangles,
...
mkdirSync(new URL('docs/harvest-wheelbarrow-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/harvest-wheelbarrow-2026/release-manifest.json', root),
