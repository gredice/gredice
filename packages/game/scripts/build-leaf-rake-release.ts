    ...
    models: [
        {
            name,
            ...file(path),
            url: `https://vrt.gredice.com${gameAssetModels.LeafRake.url}`,
            triangles,
...
mkdirSync(new URL('docs/leaf-rake-2026/', root), { recursive: true });
writeFileSync(
    new URL('docs/leaf-rake-2026/release-manifest.json', root),
