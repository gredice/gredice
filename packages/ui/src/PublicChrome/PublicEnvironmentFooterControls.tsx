...
export function PublicEnvironmentFooterControls() {
    ...
    return (
        <div className="w-full max-w-sm">
            <details className="rounded-xl border border-border/70 bg-background/70 p-3 text-left shadow-sm backdrop-blur-xl">
                ...
                <div className="mt-4 grid gap-4">
                    <div className="grid gap-3 rounded-xl border border-border/70 bg-background/65 p-3">
                        ...
                        <div className="grid grid-cols-[1fr_auto] items-center gap-3">
                            <label className="sr-only" htmlFor={timeSliderId}>
                                Vrijeme dana
                            </label>
                            <input
