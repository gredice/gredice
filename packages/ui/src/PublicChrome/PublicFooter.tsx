...
import { Footer1, SectionsView } from '../cms';
import {
    CompanyFacebook,
    CompanyGitHub,
    CompanyReddit,
...
export function CompanyInstagram(props: SVGProps<SVGSVGElement>) {
    return (
...
export function CompanyWhatsApp(props: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
function sectionsData(linkMode: PublicChromeLinkMode): SectionData[] {
    return [
        {
            component: 'Footer1',
            ...
            features: [
                {
                    ...
                    ctas: [
                        ...
                        },
                        {
                            ...
                            href: publicChromeHref(
                                PublicPagePaths.QualityHarvestSafety,
                                linkMode,
                            ),
                        },
                        {
                ...
                },
                {
                    ...
                    ctas: [
                        ...
                        {
                            label: 'Sjetva biljaka',
                            href: publicChromeHref(
                                PublicPagePaths.Sowing,
                                linkMode,
                            ),
                        },
                        {
                ...
                },
                {
                    ...
                    ctas: [
                        ...
                        {
                            label: 'r/gredice',
                            href: 'https://www.reddit.com/r/gredice/',
                        },
                        {
                            label: 'Razgovori na GitHub-u',
                            href: 'https://github.com/gredice/gredice/discussions',
                        },
                    ],
                },
                {
            ...
            ctas: [
                {
                    label: 'WhatsApp zajednica',
                    href: 'https://gredice.link/wa',
                    icon: <CompanyWhatsApp />,
                },
                {
                    label: 'Instagram',
                    href: 'https://gredice.link/ig',
                    icon: <CompanyInstagram />,
                },
                {
                    label: 'Facebook',
